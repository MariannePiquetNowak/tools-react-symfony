...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('n6V+TtQIhu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SUtX9dRdWp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rbjacw96+-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('E379IAPYt+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ot6P1kH6p1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('D6CVi0aDzx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Pugj6Jjghe', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getSerializerService()
    {
        ...
        $m = new \ApiPlatform\Core\JsonApi\Serializer\ReservedAttributeNameConverter($l);
        ...
        $t = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($s, $l, $a, $b, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($s), NULL, []);

        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => $e, 2 => $k, 3 => new \ApiPlatform\Core\JsonApi\Serializer\ConstraintViolationListNormalizer($h, $m), 4 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($n, [], $l), 5 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $l), 6 => $k, 7 => new \ApiPlatform\Core\JsonApi\Serializer\ErrorNormalizer(true), 8 => $e, 9 => new \ApiPlatform\Core\JsonApi\Serializer\EntrypointNormalizer($f, $o, $n), 10 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($f, $g, $h, $p, NULL, $n, $j, $l), 11 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($f, $o, $n), 12 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($n, true), 13 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 14 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 15 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 16 => new \ApiPlatform\Core\JsonApi\Serializer\ItemNormalizer($g, $h, $o, $p, $a, $m, $f, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $q), 17 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($f, $g, $h, $o, $p, $r, $a, $l, $s, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $q), 18 => new \ApiPlatform\Core\Serializer\ItemNormalizer($g, $h, $o, $p, $a, $l, $s, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $f, $q), 19 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 20 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $l), 22 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 23 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 24 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 25 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 26 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 27 => new \ApiPlatform\Core\JsonApi\Serializer\CollectionNormalizer($p, 'page', $f), 28 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($r, $p, $o), 'page', 'pagination', $f, $a), $f, $p, $i), 29 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 30 => new \ApiPlatform\Core\JsonApi\Serializer\ObjectNormalizer($t, $o, $p, $f), 31 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($t, $o, $r), 32 => $t], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $c, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonapi'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 6 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.title' => '',
            'api_platform.description' => 'Test de API Platform',
